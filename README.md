...
<p align="center">
  <sub>arb · nova · gas</sub>
</p>

<p align="center">
  <code>.NET 10</code> &nbsp;·&nbsp; <code>MIT</code> &nbsp;·&nbsp; <code>ArbWallet</code> &nbsp;·&nbsp; <code>arbwallet</code>
</p>
...
Arbitrum One wallet — native and token balances, gas oracle hook, Nova toggle.

Same pattern as polygon-wallet for the other big L2.
...
```bash
dotnet restore arbitrum-wallet.slnx
dotnet build arbitrum-wallet.slnx -c Release
dotnet test arbitrum-wallet.slnx -c Release
```
